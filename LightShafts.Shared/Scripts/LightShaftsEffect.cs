...
{
    public partial class LightShaftsEffect : MonoBehaviour
    {
        public void Start()
        {
            ...
            if (m_Light == null)
            {
                LightShaftsPlugin._logger.LogError("Please only add the LightShaftsEffect to GameObjects with an attached Light");
                return;
            }
        ...
        void UpdateShadowmap()
        {
            ...
            {
                GameObject go = new("Depth Camera");
        ...
        public void OnRenderObject()
        {
            ...
            bool lightOnScreen = m_ForceLightIsOnScreen
                || lightPos.x >= -1 && lightPos.x <= 1 && lightPos.y >= -1 && lightPos.y <= 1;
